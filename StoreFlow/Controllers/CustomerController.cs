...
namespace StoreFlow.Controllers
{
	public class CustomerController : Controller
	{
		...
		public IActionResult CustomerGetByCity(string city, int cityCount)
		{
		...
		//Şehirlerin isimlerini getirir ve yanına sayısını yazar
		...
		public IActionResult CustomerListExceptCityIstanbul()
		{
			...
			var customersListInİstanbul = _context.Customers
				.Where(x => x.CustomerCity == "İstanbul")
				.Select(c => c.CustomerCity)
				.ToList();
			var result = allCustomers.ExceptBy(customersListInİstanbul, c => c.CustomerCity).ToList();
			return View(result);
		}
