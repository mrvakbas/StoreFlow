...
namespace StoreFlow.Controllers
{
	public class CategoryController : Controller
	{
		...
		public IActionResult ReverseCategory()
		{
			...
			var catgeoryValue2 = _context.Categories.SingleOrDefault(x => x.CategoryName == "Bilgisayar");
			ViewBag.v2 = catgeoryValue2.CategoryStatus + "-" + catgeoryValue2.CategoryId.ToString();	
